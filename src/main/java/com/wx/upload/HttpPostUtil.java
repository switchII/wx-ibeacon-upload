...
public class HttpPostUtil {
    ...
    public static void main(String[] args) throws Exception {
        File file=new File("/Users/Desktop/demo.jpg");
        //此处修改为自己上传文件的地址
        HttpPostUtil post = new HttpPostUtil("https://api.weixin.qq.com/shakearound/material/add?access_token=IJiDTn5IPMG9vexoJUeITE1wotW8tJIndCzJDI-GEhCoEb5m35XPtY5A0QOLJMGOXpq5MYIRfYgRoM30EUttn3rmO6n7SMnwFqd8N2pGNWDyIvplWNLM7cLb2OSGY5n8TIIjAHACRR&type=icon");
